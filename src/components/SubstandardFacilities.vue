...
.body {
  ...
  background-image:linear-gradient(
          ...
          rgba(215, 205, 205, 0.7)), url('https://images.unsplash.com/photo-1556798060-3d3c4e478d1e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1330&q=80');
  h4 {
    margin-bottom: 40px;
    text-align: center;
    font-weight: 600;
