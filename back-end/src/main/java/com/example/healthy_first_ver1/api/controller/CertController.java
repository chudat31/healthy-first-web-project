...
public class CertController {
    ...
    //Lấy thông tin tất cả giấy chứng nhận
    @GetMapping
    ...
    @PatchMapping("/{id}")
    public ResponseEntity<ApiResponse> updateCertificate(@PathVariable("id") Long _id, @RequestBody CertificateForm _form) {
        Certificate certificate = certificateService.updateCertificate(_id, _form.getEndDate());
